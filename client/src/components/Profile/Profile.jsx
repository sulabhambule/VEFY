...
const Profile = () => {
  ...
  const [age1, setAge] = useState(18);
  const [height1, setHeight] = useState(175);
  const [weight1, setWeight] = useState(175);
    ...
    <div className="">
      ...
      <div className="font-medium flex flex-col gap-2 mt-[5vh]  border px-[40vh] rounded-sm  py-[5vh] ">
        <div className="flex flex-col md:flex-row gap-4 items-center">
          <label className="w-20 text-lg font-semibold text-gray-700">
            Name:
          </label>
          <input
            placeholder={name1 ? name1 : "Enter your name"}
            className="border border-gray-300 rounded-md p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full md:w-auto"
            aria-label="name"
      ...
      <div className="flex items-center justify-content pt-[5vh] gap-4">
        ...
        {allergyToggle ? (
          ...
          <div className="text-3xl font-bold" onClick={handleAllergyToggle}>
            +
          </div>
        )}
